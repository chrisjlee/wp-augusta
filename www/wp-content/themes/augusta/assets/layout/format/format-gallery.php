...
<div id="post-<?php the_ID();?>" <?php post_class();?>>
  <div class="entry-post-format">
    <header class="entry-header">
      ...
      <p>
        <?php echo get_the_date();?> <?php _e('by', 'yoko');?> <?php the_author()
        ?>
        <?php if ( comments_open() ) :
        ?>
        | <?php comments_popup_link(__('0 comments', 'yoko'), __('1 Comment', 'yoko'), __('% Comments', 'yoko'));?><?php endif;?>
      </p>
...
$image_img_tag = wp_get_attachment_image( $image->ID, 'medium' );
    ...
    <div class="entry-post-format">
      ...
      <?php endif;?>
      <p class="pics-count">
        <?php printf(_n('This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>', $total_images, 'yoko'), 'href="' . get_permalink() . '" title="' . sprintf(esc_attr__('Permalink to %s', 'yoko'), the_title_attribute('echo=0')) . '" rel="bookmark"', number_format_i18n($total_images));?>
      </p>
