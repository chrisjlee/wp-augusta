...
function display_my_customs($id = 0){
    ...
    foreach($second_array as $second_key => $second_value) $result[$second_key] = $second_value[0];
  }
...
<div id="site-generator" class="grid_6 omega">
	...
	<a href="<?php echo esc_url( __('http://globerunnerseo.com/', 'Globerunnerseo') ); ?>" title="<?php esc_attr_e('Dallas SEO', 'Globerunnerseo'); ?>" rel="generator">Dallas SEO, GloberunnerSEO.com</a>
</div><!-- #site-generator -->	
<?php
}
