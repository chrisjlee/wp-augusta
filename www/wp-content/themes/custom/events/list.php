...
?>
<body id="events"
  <?php if (function_exists('body_class')) { body_class('event-list'); } ?>
>
  <?php get_template_part( 'tpt-header', 'page' ); ?>
  <div id="container" class="sxn grid_24">
    <div id="content" class="grid_24">
    <div id="main" class="sxn">
        <div id="content-body" class="grid_17 alpha">
          <div id="tec-content" class="upcoming">
            <div id='tec-events-calendar-header' class="clearfix">
              <h2 class="tec-cal-title">
                <?php _e('Calendar of Events', $spEvents->pluginDomain) ?>
              </h2>
              <span class='tec-calendar-buttons'><a class='tec-button-on' href='<?php echo events_get_listview_link(); ?>'>
                  <?php _e('Event List', $spEvents->pluginDomain)?>
                </a><a class='tec-button-off' href='<?php echo events_get_gridview_link(); ?>'>
		...
		?>
            ...
            <div id="tec-events-loop" class="tec-events post-list clearfix">
              ...
              <div id="post-<?php the_ID() ?>" class="tec-event post clearfix<?php echo $alt ?>">
                ...
                <h4 class="event-day">
                  <?php echo the_event_start_date( null, false ); ?>
                </h4>
                <?php endif; ?>
                ...
                <div class="tec-event-list-meta">
                  <table cellspacing="0">
                    <tr>
                      <td class="tec-event-meta-desc">
                        <?php _e('Start:', $spEvents->pluginDomain) ?>
                      </td>
                      <td class="tec-event-meta-value">
                    ...
                    <tr>
                      <td class="tec-event-meta-desc">
                        ...
                        <a class="gmap" href="<?php event_google_map_link( null, $mapArgs ); ?>" title="Click to view a Google Map" target="_blank">
              ...
              <!-- End post -->
              <div class="tec-events-list content_footer">
              </div>
			...
			if( events_displaying_upcoming() && get_previous_posts_link( ) ) : ?>
                ...
                <a href='<?php echo events_get_past_link(); ?>'><span>
                    <?php _e('&laquo; Previous Events', $spEvents->pluginDomain ); ?>
                  </span></a>
			...
			if( events_displaying_upcoming() && get_next_posts_link( ) ) : ?>
                ...
                <?php elseif( events_displaying_past() && !get_previous_posts_link( ) ) : ?>
                <a href='<?php echo events_get_upcoming_link(); ?>'><span>
                    <?php _e('Next Events &raquo;', $spEvents->pluginDomain); ?>
                  </span></a>
                <?php endif; ?>
              </div>
            </div>
        ...
        <div id="sidebar-primary-widget" class="bfl grid_7 omega"><?php get_sidebar('page'); ?></div>
        <!-- end contentinside -->
      <div>
      </div>
      <!-- end content -->
