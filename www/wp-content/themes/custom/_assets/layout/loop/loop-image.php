...
<div class="post-class('post sxn')" id="post-<?php the_ID();?>">
  <h2><a href="<?php echo get_permalink($post -> post_parent);?>" rel="attachment">
  ...
  <div class="entry section">
    ...
    <div class="entry-content"><?php the_content('<p class="serif">Read the rest of this entry &raquo;</p>');?></div>
    <?php get_template_part('assets/layouts/post/post-nav'); ?>
    <br class="clear" />
