<div id="content-posts" class="bfl grid_17 suffix_1 alpha"><?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  ...
  <div <?php post_class() ?> id="post-<?php the_ID(); ?>">
    ...
    <div class="postmetadata alt section"> <small> This entry was posted
