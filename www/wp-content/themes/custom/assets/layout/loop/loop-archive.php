<div id="content-posts" class="bfl grid_17 suffix_1 alpha">
  ...
  <div id="content-header" class="">
    ...
    <?php }?>
    <?php get_template_part('includes/post/post','nav'); ?>
    <?php while (have_posts()) : the_post();
    ?>
    <div <?php post_class() ?> id="post-<?php the_ID();?>">
      <?php
      get_template_part('includes/post/post','header');
      ?>
      <div class="entry section">
        <?php the_content('Read the rest of this entry &raquo;');?>
      </div>
      <div class="post-footer section">
        <?php get_template_part('includes/post/post','byline'); ?>
        <?php get_template_part('includes/post/post','meta'); ?>
      </div>
    </div>
    <?php endwhile;?>
    <?php get_template_part('includes/post/post','nav'); ?>
